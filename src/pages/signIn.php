...
<!--   <script src="https://kit.fontawesome.com/d9162f00fa.js" crossorigin=""></script>-->
</head>
<body class="">
...
<main class="container">
  <div class="sign-in">
    <form class="form my-5" style="" action="signin.php" method="POST">
     ...
     <!-- Show Error Message -->
      ...
      <div class="mb-3">
        <div class="input-container my-5 col-md-6" style="margin: auto;">
          ...
          <label for="signin-email-animated-input">Email</label>
      ...
      <div class="text-center">
        <button type="submit" class="btn btn-primary sign-up-btn mb-2">Sign in</button>
          <p class="text-center text-muted">Do not have an account? <a href="signUp.php" class="">Sign up</a></p>
      </div>
    </form>
  </div>
</main>
