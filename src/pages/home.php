...
<header class="header background-img">
   <div class="container">
      ...
      <div class="header-heading">
         <h1 class="header-heading-text">Welcome</h1>
         <h1 class="header-heading-text">to NIS</h1>
         <h1 class="header-heading-text d-inline-block st">Student</h1>
         <h1 class="header-heading-text d-inline-block">Council</h1>
      </div>
      <div class="little-text-under-heading">
         <p class="text-mid">Be the part of school life</p>
      </div>
      <div class="buttons-under-heading">
         <a class="btn-1 text-mid mx-1" href="signUp.php">Start now
            <svg  xmlns="http://www.w3.org/2000/svg" width="7" height="11" viewBox="0 0 7 11" fill="none">
               <path fill-rule="evenodd" clip-rule="evenodd" d="M3.29289 5.50001L0 2.20712L1.41421 0.792908L6.12132 5.50001L1.41421 10.2071L0 8.79291L3.29289 5.50001Z" fill="white"/>
            </svg>
         </a>
         <a class="btn-2 text-mid mx-1" href="#social-medias">Contact us
            <svg  xmlns="http://www.w3.org/2000/svg" width="7" height="11" viewBox="0 0 7 11" fill="none">
               <path fill-rule="evenodd" clip-rule="evenodd" d="M3.29289 5.50001L0 2.20712L1.41421 0.792908L6.12132 5.50001L1.41421 10.2071L0 8.79291L3.29289 5.50001Z" fill="black"/>
            </svg>
         </a>
      </div>
   </div>
